        ...
        <header className="space-y-4 fade-in">
          ...
          <div className="pt-2">
            ...
            <ul className="text-sm md:text-base space-y-2 text-foreground/80 list-disc list-inside leading-relaxed">
              <li>Building embedded systems and sensor-fusion hardware at VertiGone, an assistive wearable project I co-founded.</li>
              ...
              <li>Previously worked on ML systems and data infrastructure at Y-Point Analytics.</li>
